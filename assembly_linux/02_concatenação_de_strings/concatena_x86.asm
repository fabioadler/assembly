...
_start:
    ...
    mov esi,msg1    ;carregamos a str (msg1) em esi
    mov edi,buffer  ;aponta o destino da str
    mov ecx,len1    ;carregamos o tamanho da str
    ...
    mov eax,sys_write
    mov ebx,std_out
    mov ecx,buffer      ;Vamos escrever na tela o valor que estar no nosso buffer que e a junção das 2 str
    mov edx,128         ;Aqui vamos passar o tamanho que definimos anteriormente para o buffer
    int sys_call
