...
.loop:
    mov eax,esi                 ;carreganos o valor de esi em eax, para não alterarmos o valor de esi 
    add eax,'0'                 ;Adicionamos um '0' dessa forma, para convertermos para str
    mov [num],eax               ;Carregamos o conteudo de eax no endereço de memoria que reservamos para num
    ...
    mov ecx,num                 ;Carregamos a mensagem para ser escrita
    mov edx,0x3                 ;Colocamos o tamanho de 0x3 = 3 bytes, por que e o numero e os outros 2 caracteres que Adicionamos
    call .print                 ;Chamamos a nossa função de print

    cmp esi,edi                 ;Confere se o valor de esi atual e igual ao de edi que passamos antés call para chamar a funão
    je .fim_loop                ;Se a confição for verdadeira pular para o .fim_loop
    inc esi                     ;Incrementa esi com +1
