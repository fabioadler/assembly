...
_start:     			;Esse já e um ponto de codigo
	...
	mov ecx,msg1		;Vamos passar os parametros ecx e edx normalmente como se fossemos escrever na tela
	mov edx,len1	
...
print: 		;Criamos um ponto que vai agir como uma função print
	mov eax,sys_write	;prexemos eax e ebx, da mesma forma como se fossemos escrever na console
	mov ebx,std_out
	int sys_call		
